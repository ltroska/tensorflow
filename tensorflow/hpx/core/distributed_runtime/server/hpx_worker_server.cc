...
using hpx_worker_server_type = hpx::components::component<hpx_worker_server_component>;
...
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::RunGraphAction, HPXWorkerServerRunGraphAction);
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::CleanupGraphAction, HPXWorkerServerCleanupGraphAction);
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::CleanupAllAction, HPXWorkerServerCleanupAllAction);
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::RecvTensorAction, HPXWorkerServerRecvTensorAction);
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::LoggingAction, HPXWorkerServerLoggingAction);
HPX_REGISTER_ACTION(tensorflow::server::HPXWorkerServer::TracingAction, HPXWorkerServerTracingAction);