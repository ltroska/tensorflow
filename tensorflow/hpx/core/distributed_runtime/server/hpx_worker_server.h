...
struct HPXWorkerServer : hpx::components::simple_component_base<HPXWorkerServer>
{  
  HPXWorkerServer() {}
  ~HPXWorkerServer() {}
  ...
  std::pair<Status, RegisterGraphResponse> RegisterGraph(RegisterGraphRequest const& request) 
  {  
  ...
  HPX_DEFINE_COMPONENT_ACTION(HPXWorkerServer, RegisterGraph, RegisterGraphAction);  
  
  std::pair<Status, DeregisterGraphResponse> DeregisterGraph(DeregisterGraphRequest const& request) 
  {  
  ...
  HPX_DEFINE_COMPONENT_ACTION(HPXWorkerServer, DeregisterGraph, DeregisterGraphAction);
  ...
  std::pair<Status, RunGraphResponse> RunGraph(RunGraphRequest const& request)
  {
    ...
    auto done = 
      [&p, wrapped_request, wrapped_response](Status s)
      {
        p.set_value(s);
    ...
    worker_->RunGraphAsync(&opts, wrapped_request, wrapped_response, std::move(done));
  ...
  std::pair<Status, CleanupGraphResponse> CleanupGraph(CleanupGraphRequest const& request)
  {
  ...
  HPX_DEFINE_COMPONENT_ACTION(HPXWorkerServer, CleanupGraph, CleanupGraphAction);

  std::pair<Status, CleanupAllResponse> CleanupAll(CleanupAllRequest const& request)
  {
...
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::RunGraphAction, HPXWorkerServerRunGraphAction);
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::CleanupGraphAction, HPXWorkerServerCleanupGraphAction);
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::CleanupAllAction, HPXWorkerServerCleanupAllAction);
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::RecvTensorAction, HPXWorkerServerRecvTensorAction);
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::LoggingAction, HPXWorkerServerLoggingAction);
HPX_REGISTER_ACTION_DECLARATION(tensorflow::server::HPXWorkerServer::TracingAction, HPXWorkerServerTracingAction);
