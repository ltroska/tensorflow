  ...
  : hpx::components::client_base<HPXMasterClient, server::HPXMasterServer>
{
    using base_type = hpx::components::client_base<
            HPXMasterClient, server::HPXMasterServer>;
    ...
    Status CreateSession(CallOptions* call_options,
      ...
      return CallActionSync<s_type::CreateSessionAction>
        (request, response);
    }
    ...
    Status ExtendSession(CallOptions* call_options,
      ...
      return CallActionSync<s_type::ExtendSessionAction>
        (request, response);
    }
    ...
    Status PartialRunSetup(CallOptions* call_options,
      ...
      return CallActionSync<s_type::PartialRunSetupAction>
        (request, response);
    }

    Status RunStep(CallOptions* call_options, const RunStepRequest* request,
                   RunStepResponse* response) {
      return CallActionSync<s_type::RunStepAction>
        (request, response);
    }
    ...
    Status CloseSession(CallOptions* call_options,
      ...
      return CallActionSync<s_type::CloseSessionAction>
        (request, response);
    }
    ...
    Status ListDevices(CallOptions* call_options,
      ...
      return CallActionSync<s_type::ListDevicesAction>
        (request, response);
    }

    Status Reset(CallOptions* call_options, const ResetRequest* request,
                 ResetResponse* response) {
      return CallActionSync<s_type::ResetAction>
        (request, response);
    }
  ...
  protected:
    ...
    {
      std::pair<Status, Response> result =
        Action()(get_id(), *req);
